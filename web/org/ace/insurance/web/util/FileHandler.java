...
public class FileHandler {
	...
	public static void moveFilesWithOverride(String systemPath, String sourceDirectoryPath, String destinationDirectoryPath) throws IOException {

		/** ISSUES:FILE MISSING */
		/** Avoid to delete the whole folder under UPLOAD 22-MAR */
		...
		// clear the source folder
		File deleteDir = new File(systemPath + sourceDirectoryPath);
		FileUtils.deleteDirectory(deleteDir);
